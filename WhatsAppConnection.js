// WhatsAppConnection.js - Manages WhatsApp connection
const { default: makeWASocket, useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion } = require('@whiskeysockets/baileys');
const qrcode = require('qrcode-terminal');

// Fallback version if fetching latest fails
  ...
  async conectar() {
    ...
    try {
      ...
      try {
        ...
        console.log(`⚠️ Could not fetch latest version, using fallback: ${FALLBACK_WA_VERSION.join('.')}`);
      }
      ...
      this.sock = makeWASocket({
        ...
        browser: ['Chrome (Linux)', 'Chrome', '131.0.0'],
